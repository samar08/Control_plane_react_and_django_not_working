  ...
  return (
      ...
      <Container className={classes.nodescontainer}>
          ...
          <Grid key="master"item xs={12} sm={6} md={4}>
              ...
              <Card>
                  <CardContent>
                      <center><Button variant="contained" className={classes.clusternamestring} onClick={() => dispatch(clusterinfoactioncreator())}>Get cluster info</Button></center>
                      {k8sversion?
              ...
              <center><Button variant="contained" className={classes.clusternamestring}  onClick={()=>{navigate('/nodesinfo')}}>Get Node info</Button></center>
                     ...
                     { /*<Typography className={classes.controlplaneinfo}>Number of master nodes: {no_of_master}</Typography>
                      <Typography className={classes.controlplaneinfo}>Number of worker nodes: {no_of_worker}</Typography>*/}
                      </CardContent>
              </Card>
